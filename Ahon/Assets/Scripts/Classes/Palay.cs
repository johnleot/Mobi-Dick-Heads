...
namespace Assets.Scripts.Classes
{
	public class Palay : IObject {
		...
		void Awake()
		{
			...
			title_ = "Palay";
			contentText_ = "Palay: The quick brown fox jumps over the lazy dog.";
		}
		...
		override public void insertUI()
		{
			...
			Debug.Log ("Showing Palay UI..." + gameObject);
		...
		override public void hideUI()
		{
			...
			Debug.Log ("Hiding Palay UI..." + gameObject);
		}
		...
		void showInfoWindow()
		{
			...
			image.sprite = Resources.Load("ResourcesIcons/PALAY",typeof(Sprite)) as Sprite;
